...
void
print::visit (t_log_compilers &n)
{
  //puts (__PRETTY_FUNCTION__);
}

void
print::visit (t_filtervar &n)
{
  //puts (__PRETTY_FUNCTION__);
}

void
print::visit (t_headers &n)
{
  //puts (__PRETTY_FUNCTION__);
}

void
print::visit (t_callvar &n)
{
  //puts (__PRETTY_FUNCTION__);
}

void
print::visit (t_check_flags &n)
{
  //puts (__PRETTY_FUNCTION__);
}

void
print::visit (t_test &n)
{
  //puts (__PRETTY_FUNCTION__);
}

void
print::visit (t_flag_import &n)
{
  //puts (__PRETTY_FUNCTION__);
}

void
print::visit (t_flag &n)
{
  //puts (__PRETTY_FUNCTION__);
}

void
print::visit (t_data &n)
{
  //puts (__PRETTY_FUNCTION__);
}

void
print::visit (t_log_compiler &n)
{
  //puts (__PRETTY_FUNCTION__);
}

void
print::visit (t_built_sources &n)
{
  //puts (__PRETTY_FUNCTION__);
}

void
print::visit (t_extern &n)
{
  //puts (__PRETTY_FUNCTION__);
}
...
void
print::visit (t_varadd &n)
{
  //puts (__PRETTY_FUNCTION__);
}

void
print::visit (t_scripts &n)
{
  //puts (__PRETTY_FUNCTION__);
}

void
print::visit (t_accessvar &n)
{
  //puts (__PRETTY_FUNCTION__);
}

void
print::visit (t_mans &n)
{
  fprintf (fh, "mans ");
  visitor::visit (n);
}

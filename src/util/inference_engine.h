...
struct inference_engine
{
  ...
  void add_rule (std::string const &target, prerequisite const &dep0) { std::vector<prerequisite> v; v.push_back (dep0); add_rule (target, v, 0, 0); }
  void add_rule (std::string const &target, prerequisite const &dep0, prerequisite const &dep1) { std::vector<prerequisite> v; v.push_back (dep0); v.push_back (dep1); add_rule (target, v, 0, 0); }
  void add_rule (std::string const &target, prerequisite const &dep0, prerequisite const &dep1, prerequisite const &dep2) { std::vector<prerequisite> v; v.push_back (dep0); v.push_back (dep1); v.push_back (dep2); add_rule (target, v, 0, 0); }
  void add_rule (std::string const &target, prerequisite const &dep0, prerequisite const &dep1, prerequisite const &dep2, prerequisite const &dep3) { std::vector<prerequisite> v; v.push_back (dep0); v.push_back (dep1); v.push_back (dep2); v.push_back (dep3); add_rule (target, v, 0, 0); }
  void add_rule (std::string const &target, prerequisite const &dep0, prerequisite const &dep1, prerequisite const &dep2, prerequisite const &dep3, prerequisite const &dep4) { std::vector<prerequisite> v; v.push_back (dep0); v.push_back (dep1); v.push_back (dep2); v.push_back (dep3); v.push_back (dep4); add_rule (target, v, 0, 0); }
  void add_rule (std::string const &target, prerequisite const &dep0, prerequisite const &dep1, prerequisite const &dep2, prerequisite const &dep3, prerequisite const &dep4, prerequisite const &dep5) { std::vector<prerequisite> v; v.push_back (dep0); v.push_back (dep1); v.push_back (dep2); v.push_back (dep3); v.push_back (dep4); v.push_back (dep5); add_rule (target, v, 0, 0); }
  void add_rule (std::string const &target, prerequisite const &dep0, prerequisite const &dep1, prerequisite const &dep2, prerequisite const &dep3, prerequisite const &dep4, prerequisite const &dep5, prerequisite const &dep6) { std::vector<prerequisite> v; v.push_back (dep0); v.push_back (dep1); v.push_back (dep2); v.push_back (dep3); v.push_back (dep4); v.push_back (dep5); v.push_back (dep6); add_rule (target, v, 0, 0); }
  void add_rule (std::string const &target, prerequisite const &dep0, prerequisite const &dep1, prerequisite const &dep2, prerequisite const &dep3, prerequisite const &dep4, prerequisite const &dep5, prerequisite const &dep6, prerequisite const &dep7) { std::vector<prerequisite> v; v.push_back (dep0); v.push_back (dep1); v.push_back (dep2); v.push_back (dep3); v.push_back (dep4); v.push_back (dep5); v.push_back (dep6); v.push_back (dep7); add_rule (target, v, 0, 0); }
  void add_rule (std::string const &target, prerequisite const &dep0, prerequisite const &dep1, prerequisite const &dep2, prerequisite const &dep3, prerequisite const &dep4, prerequisite const &dep5, prerequisite const &dep6, prerequisite const &dep7, prerequisite const &dep8) { std::vector<prerequisite> v; v.push_back (dep0); v.push_back (dep1); v.push_back (dep2); v.push_back (dep3); v.push_back (dep4); v.push_back (dep5); v.push_back (dep6); v.push_back (dep7); v.push_back (dep8); add_rule (target, v, 0, 0); }
  void add_rule (std::string const &target, prerequisite const &dep0, prerequisite const &dep1, prerequisite const &dep2, prerequisite const &dep3, prerequisite const &dep4, prerequisite const &dep5, prerequisite const &dep6, prerequisite const &dep7, prerequisite const &dep8, prerequisite const &dep9) { std::vector<prerequisite> v; v.push_back (dep0); v.push_back (dep1); v.push_back (dep2); v.push_back (dep3); v.push_back (dep4); v.push_back (dep5); v.push_back (dep6); v.push_back (dep7); v.push_back (dep8); v.push_back (dep9); add_rule (target, v, 0, 0); }
